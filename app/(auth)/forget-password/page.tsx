...
export default function ForgetPage () {
  ...
  return (
    ...
    >
      <div className='relative z-40 w-full max-w-[431px] bg-[#EAEAEA00] backdrop-blur-md shadow-2xl p-8 -mt-[150px] lg:-mt-[300px]'>
        <div className='text-center max-w-[356px]'>
          ...
          <h1 className='text-[24px] font-bold text-[#5D5D5D] mt-5'>Forget Password</h1>
          <h2 className='text-[10px] text-[#767676] mt-2 w-[233px] mx-auto'>
